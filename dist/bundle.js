...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = setTreasure;
/* harmony export (immutable) */ __webpack_exports__["b"] = getTrackCategory;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_treasure__ = __webpack_require__(3);
...
function setTreasure () {
  window.treasure = new __WEBPACK_IMPORTED_MODULE_0_treasure__["a" /* default */]();
...
function getTrackCategory ( _this ) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib__ = __webpack_require__(0);
...
class Treasure {
  ...
  resolve ( i ) {
    ...
    target.timer = setTimeout( function () {
      if ( target.debug ) {
        ...
        const targetCategory = __WEBPACK_IMPORTED_MODULE_0_lib__["b" /* getTrackCategory */]( $(target.element) );
  ...
  reject ( i ) {
    const that = this;
    const target = this.elements[i];
    if ( target.debug ) { console.log( `Reject: ` + __WEBPACK_IMPORTED_MODULE_0_lib__["b" /* getTrackCategory */]( $(target.element) ) ); }
    clearTimeout( target.timer );
  }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Treasure;
...
class Init {
  constructor () {
    __WEBPACK_IMPORTED_MODULE_2_lib__["a" /* setTreasure */]();
  }
}
